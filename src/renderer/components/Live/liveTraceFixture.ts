...
/**
 * Real capture, used only by the dev-mode fixtures so the dossier trace chart
 * can be iterated on without a running game.
 *
 * Daytona Road Course, 2026-08-02: the following car arrives under braking
 * about 13 m/s faster, closes from ~15 m to ~5 m, and loses 4 m/s in a single
 * sample at contact. Trimmed to t in [-1.3, +0.35]; values are unmodified.
 */
// prettier-ignore
export const leadingCarFrames: LiveIncidentFrame[] = [
...
// prettier-ignore
export const followingCarFrames: LiveIncidentFrame[] = [
