...
export const DriverOverviewCard: React.FC<DriverOverviewCardProps> = ({
  driver,
}) => {
  const startingPosition =
    Number.isFinite(driver.startingPosition) &&
    Number(driver.startingPosition) > 0
  ...
  return (
    <Paper
      variant="outlined"
      sx={{ borderColor: 'divider', p: 2, borderRadius: 2 }}
    >
