...
import {
  ReplayIncidentEvent,
  ReplayIncidentType,
} from '../Replay/ReplayMasterIncidentTimeline';
...
export const DriverIncidentHistoryTimeline: React.FC<
  DriverIncidentHistoryTimelineProps
> = ({
  filteredIncidents,
              ...
              <Stack
                ...
                sx={{
                  ...
                  backgroundColor: isActiveIncident
                    ? 'background.default'
                    : 'transparent',
                  borderLeft: isActiveIncident
                    ? '2px solid'
                    : '2px solid transparent',
                  borderLeftColor: isActiveIncident
                    ? 'text.disabled'
                    : 'transparent',
                  cursor: 'pointer',
                  '&:hover': {
              ...
              >
                ...
                <Stack spacing={1} sx={{ flex: 1 }}>
                  ...
                  <Stack direction="row" spacing={1} alignItems="center">
                    ...
                    >
                      {incident.drivers.map((entry, driverIndex) => (
                        <Stack
                          // Replay incidents are immutable, and the index only
                          // disambiguates repeated car numbers in one incident.
                          // eslint-disable-next-line react/no-array-index-key
                          key={`${incident.id}-${entry.carNumber}-${driverIndex}`}
                          direction="row"
                          spacing={0.5}
                          alignItems="center"
                          useFlexGap
