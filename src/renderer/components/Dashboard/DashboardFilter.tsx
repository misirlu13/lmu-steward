  ...
  return (
    <>
      ...
      >
        ...
        >
          <FormControl fullWidth size="small">
            <InputLabel id="session-length-select-label">
              Session Length
            </InputLabel>
            <Select
        ...
        <Box
          sx={{
            ...
            position: 'sticky',
            bottom: 0,
            // Outlined InputLabel ships with zIndex 1, so the footer needs to
            // sit above it or label text bleeds through while scrolling.
            zIndex: 2,
          }}
          onClick={(event) => event.stopPropagation()}
          onKeyDown={(event) => event.stopPropagation()}
